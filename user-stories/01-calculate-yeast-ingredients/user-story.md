# Calculate Yeast Bread Ingredients

## Slice
1 — Yeast Recipe Calculator

## Story
As a home baker, I want to adjust loaf count, weight, and yeast type and see ingredient weights update live, so that I can plan any batch size.
